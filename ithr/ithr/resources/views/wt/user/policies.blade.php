...
<div class="px-2">
<div class="mb-3">
    <h3 class="text-sm font-extrabold text-[#3D2B1F] tracking-tight">Policies</h3>
...
<div class="bg-white rounded-2xl shadow-sm border border-[#8B5E3C]/10 overflow-hidden">
    <div class="p-8 text-center bg-stone-50/50">
        ...
        <h4 class="text-[11px] font-black text-[#3D2B1F] uppercase tracking-wider mb-2">Content Under Development</h4>
