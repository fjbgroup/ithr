...
<aside class="sidebar" id="sidebar">
    <div style="display:flex;align-items:center;padding:1.1rem 1.25rem 1rem;border-bottom:1px solid var(--sidebar-border);gap:.75rem">
        ...
        <a href="{{ Auth::check() ? route('lms.dashboard') : route('login') }}" style="text-decoration:none;display:flex;align-items:center;flex:1;font-family:'Inter',sans-serif;font-size:1.05rem;font-weight:700;color:var(--sidebar-brand-text);" title="Go to Dashboard">
            E-Learning LMS
        </a>
    ...
    <nav class="sidebar-nav">
        @auth
        <a href="{{ route('lms.dashboard') }}" class="nav-item {{ request()->routeIs('lms.dashboard') ? 'active' : '' }}">
