...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @if(\App\Models\IT\EmailSetting::systemEnabled('lms') || Auth::user()->isAdminIT())
        ...
        <a href="{{ route('wt.login') }}" class="nav-item">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="8" width="10" height="14" rx="2" ry="2"/><path d="M9 8V3"/><path d="M15 8V6"/><circle cx="12" cy="16" r="2"/><line x1="10" y1="11" x2="14" y2="11"/></svg>
            WT System
        </a>
