...
html.sidebar-collapsed .nav-group-children.open .nav-link {
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    {{-- Admin: All Assets with sub-nav --}}
      <div class="nav-group" id="navGroupAdminITAssets">
        <div class="nav-group-toggle {{ $itActive ? 'open has-active' : '' }}" onclick="toggleNavGroup('navGroupAdminITAssets')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-box-seam-fill" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">All Assets</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        </div>
        <div class="nav-group-children {{ $itActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
          <a href="{{ route('it.inventory.index') }}" class="nav-link {{ request()->routeIs('it.inventory.index') && !request()->get('view') ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
            <i class="bi bi-box-seam" style="font-size:14px"></i> IT Assets
          </a>
          <a href="{{ route('it.non-it.index') }}" class="nav-link {{ request()->routeIs('it.non-it.index') ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
            <i class="bi bi-boxes" style="font-size:14px"></i> Non-IT Assets
          </a>
          <a href="{{ route('it.inventory.index') }}?view=pending_requests" class="nav-link {{ $itPending ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
    ...
    {{-- Non-admin: IT + Non-IT + My Requests --}}
      <div class="nav-group" id="navGroupNonAdminITAssets">
        <div class="nav-group-toggle {{ $itActive ? 'open has-active' : '' }}" onclick="toggleNavGroup('navGroupNonAdminITAssets')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-box-seam-fill" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">All Assets</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        ...
        <div class="nav-group-children {{ $itActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
          <a href="{{ route('it.inventory.index') }}" class="nav-link {{ request()->routeIs('it.inventory.index') && !$itMyRequests ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
            <i class="bi bi-box-seam" style="font-size:14px"></i> IT Assets
          </a>
          <a href="{{ route('it.non-it.index') }}" class="nav-link {{ request()->routeIs('it.non-it.index') ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
            <i class="bi bi-boxes" style="font-size:14px"></i> Non-IT Assets
          ...
          <a href="{{ route('it.inventory.index') }}?view=my_requests" class="nav-link {{ $itMyRequests ? 'active' : '' }}" style="padding:7px 12px;font-size:13px">
    ...
    <div class="nav-group" id="navGroupEwaste">
        <div class="nav-group-toggle {{ $ewActive ? 'open has-active' : '' }}"
          onclick="toggleNavGroup('navGroupEwaste')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-recycle" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">E-Waste</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        </div>
        <div class="nav-group-children {{ $ewActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
    ...
    <div class="nav-group" id="navGroupDisposal">
        <div class="nav-group-toggle {{ $dispActive ? 'open has-active' : '' }}"
          onclick="toggleNavGroup('navGroupDisposal')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-trash3-fill" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">Disposal</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        </div>
        <div class="nav-group-children {{ $dispActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
    ...
    <div class="nav-group" id="navGroupReports">
        <div class="nav-group-toggle {{ $rptActive ? 'open has-active' : '' }}"
          onclick="toggleNavGroup('navGroupReports')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-bar-chart-line-fill" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">Reports</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        </div>
        <div class="nav-group-children {{ $rptActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
    ...
    <div class="nav-group" id="navGroupITRequestForm">
        <div class="nav-group-toggle {{ $itrActive ? 'open has-active' : '' }}"
          onclick="toggleNavGroup('navGroupITRequestForm')"
          style="width:100%;display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;cursor:pointer;margin-bottom:2px;transition:all .15s;text-align:left">
          <i class="bi bi-file-earmark-text-fill" style="font-size:16px;width:20px;text-align:center;flex-shrink:0"></i>
          <span style="flex:1;font-size:13.5px;font-weight:500;color:var(--sidebar-text)">IT Request Form</span>
          <i class="bi bi-chevron-down toggle-arrow" style="font-size:11px;transition:transform .2s"></i>
        </div>
        <div class="nav-group-children {{ $itrActive ? 'open' : '' }}">
          <div class="nav-group-children-inner">
